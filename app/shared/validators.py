...
def validate_id_field(id_value: str, invalid_error: str) -> tuple[int | None, list[str]]:
    try:
        id_int = int(id_value)
...
def validate_enum(enum_str: str, enum_cls: type[Any], invalid_error: str) -> tuple[Any, list[str]]:
    try:
