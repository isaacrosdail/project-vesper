...
class Habit(Base):
    ...
    promotion_threshold = Column(
        Float,
        CheckConstraint(f'promotion_threshold >= {PROMOTION_THRESHOLD_MIN} AND promotion_threshold <= {PROMOTION_THRESHOLD_MAX}', name='ck_promotion_threshold_range_0_1'),
        default=PROMOTION_THRESHOLD_DEFAULT
    )
