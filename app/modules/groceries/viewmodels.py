...
from app.modules.groceries.models import Recipe
from app.modules.groceries.service import IngredientShortfall
...
# class RecipeSlotViewModel(BaseViewModel):
#     __slots__ = (
#         "id",
#         "name",
#         "yields",
...
#     def __init__(self, recipe: Recipe, shortfalls: list[IngredientShortfall]) -> None:
#         self.id = recipe.id
#         self.name = recipe.name
#         self.yields = recipe.yields
#         self.yields_units = recipe.yields_units
#         self.missing = shortfalls
