...
class TasksService:
    ...
    def save_task(self, typed_data: dict[str, Any], task_id: int | None) -> dict[str, Any]:
        ...
        if typed_data["is_frog"]:
            ...
            if existing_frog:
                ...
                return service_response(
                    ...
                    errors={"frog_task": [f"You already have a 'frog' task for {frog_date}"]}
                )
        ...
        if task_id:
            ...
            return service_response(success=True, message="Task updated", data={"task": task})
        # CREATE
        else:
            ...
            return service_response(success=True, message="Task added", data={"task": task})
...
def tasks_patch_hook(item: Any, data: Any, session: Session, current_user: User) -> dict[str, Any]: # noqa: ANN401,ARG001
