...
def owner_required(func: Callable[P, ResponseReturnValue]) -> Callable[P, ResponseReturnValue]:
    """
...
def typed_login_required(func: Callable[P, ResponseReturnValue]) -> Callable[P, ResponseReturnValue]:
    """
