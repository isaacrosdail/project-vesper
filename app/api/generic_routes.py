...
def item(
    ...
    if not item:
        return api_response(success=False, message=f"{model_class.__name__} not found."), 404
    ...
    if request.method == "GET":
        ...
        return api_response(success=True, message=f"Retrieved {item.__tablename__}", data=data), 200
