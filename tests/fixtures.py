...
from app.modules.groceries.models import Product, Transaction, ShoppingList, ShoppingListItem, ProductCategoryEnum, UnitEnum
...
def shopping_list_item_fixture(product: Product = None, shopping_list: ShoppingList = None, **overrides) -> ShoppingListItem:
    product = product or product_fixture()
