...
## [Sat 02.08.25]
**Log:**
- Auth Retrofitting & DB Layer Cleanup
...
## [Sat 09.08.25]
**Log:**
- API Limiting Logic (Draft complete)
...
- Enforce ENV vs Auth Separation
...
## [Sun 10.08.25]
**Log:**
- Practiced git rebase on resume-site backup repo to get acquianted
- Updated docker-compose.pi.yml to mirror other compose file updates

## [Wed 13.08.25]
**Log:**
- Created theme-demo page (what is now style-reference.html) for easier styling workflow
- Implemented tooltips using JS with custom styling
- CSS Overhaul
...
## [Sat 16.08.25]
**Log:**
- Drilled JS loops/arrays & applied by converting weatherInfo's if/else chain to "Object.entries(..).find()"
- Installed Bun

## [Sun 17.08.25]
**Log:**
- Timezone Infrastructure Implementation
...
- JS Modules migration to esbuild
...
- Misc Frontend & Theme Refinements
...
**Log**:
- Build Tools: Updated scripts & moved to modern esbuild usage: separate “build” vs “watch”
- Color Work: Began OKLCH migration; started converting palette & tweaking colors

## [Tues 26.08.25] – D3.js, Modal Refactor, Template/JS Cleanup
**Log:**
- D3 Setup: added shared/charts.js
...
## [Wed 27.08.25]
**Log:**
- Bugfixing for habit completion checkbox logic
- Add SIGTERM SIGNIT things for build.mjs so esbuild properly exits
