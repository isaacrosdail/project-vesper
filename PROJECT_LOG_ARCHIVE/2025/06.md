...
- Add 2 models:
	...
	3. Alembic revision!
- Make Daily Intention on homepage now use/update our new model instead of just the element's text!

**Log:**
- Made DailyIntention & DailyMetric models
	- Alembic revision
...
- Updated Daily Intention on homepage to use DB for persistence
...
## [Tues 10.06.25]
**Goals:**
- Get started with weather API calls
**Log:**
- Weather API calls
...
## [Wed 11.06.25]
**Goals:**
- Expand weather API widget functionality a bit
- Start implementing an animated sun arc
...
**Log:**
- Expanded weather API widget functionality
	- Grab sunset time
...
- Diving back into Jest testing
	- Made a basic 2 + 2 = 4 Jest test
	- then a test to calc sun position at midday (should be 1)
- Using setInterval for both getWeatherInfo & sun drawing functionalities
...
**Up Next:**
- Stylize sun so it's clearer what it is (add horizon, sun rays, etc?)
- Add tooltip for onhover of canvas to further clarify that it moves in realtime/follows the real sun position based on sunrise and sunset of the city
- Make it read user's timezone/city so it's not hardcoded to London
...
**Log:**
- Began hamburger/mobilenav menu
...
- Added Category system to Habits
...
- Start on "Daily Check-In" widget (index.html)
	
## [Thurs 19.06.25]
**Log:**
- Implemented User model basics
...
- Updated Product/Transaction models
	- Added str methods
	- Fixed routes to handle new Product fields
- Bit more on Daily Check-In Feature
	- Began mocking up card UI
	- Created DailyCheckin model

## [Fri 20.06.25]
**Log:**
- Play around with grid styling on DailyCheckin card
- Cleaning up forms & adding basic frontend validation
...
## [Sat 21.06.25]
**Log:**
- Getting Started with Data Visualization (Plan: Start with Plotly, check out D3.js later)
	- Install plotly & plotly express: pip install plotly , and pip install plotly[express]
	- Install pandas: pip install pandas

## [Sun 22.06.25]
**Log:**
- Code Quality, UI/UX, & Architecture Improvements
