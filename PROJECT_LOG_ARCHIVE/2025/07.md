...
**Log:**
- Made "METRICS WE'RE TRACKING" note in Obsidian to keep the following straight
...
# TODOS:
- Add Docker checkhealth
- Add health/status API endpoints (have Docker checkhealth ping these too)
- Add external monitoring (also ping our health/status endpoint(s))
...
**Log:**
- Flask-Login Setup & User model enhancements
